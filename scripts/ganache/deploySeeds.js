...
module.exports = async function(callback) {
    ...
    try {
        ...
        let seedToken = await PrimeToken.at(contracts.ganache.PrimeToken);
        ...
        let fundingToken    = [ contracts.ganache.WETH, contracts.ganache.DAI, contracts.ganache.WETH, contracts.ganache.DAI, contracts.ganache.WETH ];
